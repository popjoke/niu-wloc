...
<title>Niu WLOC 虚拟定位</title>
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-title" content="Niu WLOC">
...
<footer style="padding:16px;text-align:center;font-size:13px;color:#666">
  Niu WLOC · 基于 WLOC 社区维护版 · <a href="${SOURCE_URL}" target="_blank" rel="noopener noreferrer">源码与许可证</a>
</footer>
</body>
</html>`;
}
